    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
      ...
      <footer className="mt-auto py-8 border-t border-gray-200">
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row justify-between items-center text-gray-600 gap-4">
            <p>
              Built by{" "}
              <a
                href="https://seblavoie.dev"
                target="_blank"
            ...
            <p>
              <a
                href="https://github.com/seblavoie/quick-sequence"
                target="_blank"
                rel="noopener noreferrer"
